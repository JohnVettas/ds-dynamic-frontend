...
document.addEventListener("click", (event)=>{
    if (event.target.closest("#ModeDuck")) return;
    if (duckyMode === "click") {
...
function updateDucky() {
    ...
    if (duckyMode !== "stop") requestAnimationFrame(updateDucky);
}
...
//# sourceMappingURL=404.cc5d8186.js.map
